  ...
  (server) => registerTools(server),
  {
    capabilities: {
      tools: {
        create_job: {
          description:
            "Deploy a new Nosana job (host model on a decentralized GPU) — wallet or API key",
        },
        create_job_api: {
          description: "Create a job via Nosana API (API key mode only)",
        },
        list_jobs: {
          description: "List all jobs (API key mode)",
        },
        get_job_api: {
          description: "Get job details (API key mode)",
        },
        stop_job_api: { description: "Stop a job (API key mode)" },
        update_job: { description: "Update an existing Nosana job" },
        stop_job: {
          description: "Stop a running Nosana job — wallet or API key",
        },
        extend_job_runtime: {
          description: "Extend a job runtime — wallet or API key",
        },
        ...
        get_credit_balance: {
          description:
            "Get credit balance on nosana platform — wallet or API key",
        },
