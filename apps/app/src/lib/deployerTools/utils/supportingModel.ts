...
export const MARKETS: Record<GpuMarketSlug, MarketInfo> = {
  ...
  'nvidia-4080': {
    ...
    vram_gb: 16,
    estimated_price_usd_per_hour: 0.160
  },
  'nvidia-3090': {
    slug: 'nvidia-3090',
  ...
  'nvidia-5070': {
    ...
    estimated_price_usd_per_hour: 0.240,
    vram_gb: 15
  },
  'nvidia-a5000': {
    slug: 'nvidia-a5000',
    ...
    vram_gb: 24,
    estimated_price_usd_per_hour: 0.320
  },
  'nvidia-4090': {
    slug: 'nvidia-4090',
